...
<body>
		...
		<form id="write-form"
			...
			<div class="form-group">
				...
				<input type="text" id="title"
					name="boardTitle" value="${board.getBoardTitle()}" required />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<!--textarea에는 바로 value로 못넣고 c:out으로 넣는데, 엔터치면 안된다.-->
	...
	<script src="${pagetContext.request.contextPath}/assets/js/boardWrite.js"></script>
</body>
</html>
